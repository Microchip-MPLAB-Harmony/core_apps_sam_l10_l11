...
{"0": {
    ...
    "url": "http://localhost:4000/core_apps_sam_l10_l11/mplab_harmony_license.html",
    "relUrl": "/mplab_harmony_license.html"
  },"1": {
    "doc": "I2C driver asynchronous - I2C Multi-client",
    "title": "I2C driver asynchronous - I2C Multi-client",
    "content": "This example application shows how to use multi-client feature of the I2C driver in asynchronous mode to communicate with temperature sensor and an EEPROM. ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/driver/i2c/async/i2c_multi_slave/readme.html#i2c-driver-asynchronous---i2c-multi-client",
    "relUrl": "/apps/driver/i2c/async/i2c_multi_slave/readme.html#i2c-driver-asynchronous---i2c-multi-client"
  },"2": {
    "doc": "I2C driver asynchronous - I2C Multi-client",
    "title": "Description",
    "content": "Two application tasks are created which act as clients to the same instance of the I2C driver: . APP_I2C_TEMP_SENSOR_Tasks: . | Reads temperature every 1 second, prints on console and notifies the EEPROM client | The Time System Service is used to generate a callback every 1 second | . APP_I2C_EEPROM_Tasks: . | Writes temperature values to the EEPROM once the temperature read complete notification is received | Reads and prints the last five saved temperature data back from the EEPROM when user enters any key on the console. | . ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/driver/i2c/async/i2c_multi_slave/readme.html#description",
    "relUrl": "/apps/driver/i2c/async/i2c_multi_slave/readme.html#description"
  },"3": {
    "doc": "I2C driver asynchronous - I2C Multi-client",
    "title": "Downloading and building the application",
    "content": "To clone or download this application from Github, go to the main page of this repository and then click Clone button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these instructions. Path of the application within the repository is apps/driver/i2c/async/i2c_multi_slave/firmware . To build the application, refer to the following table and open the project using its IDE. | Project Name | Description | . | sam_l10_xpro.X | MPLABX project for SAML10 Xplained Pro Evaluation Kit | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/driver/i2c/async/i2c_multi_slave/readme.html#downloading-and-building-the-application",
    ...
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_l10_xpro.X | SAML10 Xplained Pro Evaluation Kit | . |   |   | . Setting up SAML10 Xplained Pro Evaluation Kit . | To run the demo, the following additional hardware is required: . | One IO1 Xplained Pro Extension Kit board | . IO1 Xplained Pro Extension Kit Address Select: . | The A2 address line of TWI must be soldered to GND. This is done to modify the address of the the EEPROM on IO1 Xplained Pro Extension Kit | The modification changes the address of the temperature sensor to 0x4B and the EEPROM to 0x50 | . | Connect IO1 Xplained Pro Extension Kit to EXT1 header . | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/driver/i2c/async/i2c_multi_slave/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/i2c/async/i2c_multi_slave/readme.html#setting-up-the-hardware"
  },"5": {
    "doc": "I2C driver asynchronous - I2C Multi-client",
    "title": "Running the Application",
    "content": ". | Open the Terminal application (Ex.:Tera term) on the computer | Connect to the EDBG Virtual COM port and configure the serial settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Build and Program the application using its IDE | Observe the temperature values getting printed on the terminal application every 1 second and temperature value written into EEPROM notification as shown below: | Press any key on the terminal, last 5 temperature values will be read from the EEPROM and displayed as shown below. | . ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/driver/i2c/async/i2c_multi_slave/readme.html#running-the-application",
    "relUrl": "/apps/driver/i2c/async/i2c_multi_slave/readme.html#running-the-application"
  },"6": {
    "doc": "I2C driver asynchronous - I2C Multi-client",
    "title": "I2C driver asynchronous - I2C Multi-client",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/driver/i2c/async/i2c_multi_slave/readme.html",
    ...
    "content": "This example application shows how to use the SDSPI driver in asynchronous mode to perform non-blocking operations on the SD Card Media . ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/driver/sdspi/async/sdspi_read_write/readme.html#sdspi-driver-asynchronous---sdspi-read-write",
    "relUrl": "/apps/driver/sdspi/async/sdspi_read_write/readme.html#sdspi-driver-asynchronous---sdspi-read-write"
  },"8": {
    "doc": "SDSPI driver asynchronous - SDSPI Read Write",
    "title": "Description",
    "content": ". | The asynchronous mode of the SDSPI driver is configured to use DMA and performs non-blocking read and write operations | This application writes 4KB (4096 bytes) of data starting at the SD Card memory location 0x2000, using the SDSPI driver. | The application then reads and verifies the written data. | . ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/driver/sdspi/async/sdspi_read_write/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/driver/sdspi/async/sdspi_read_write/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/sdspi/async/sdspi_read_write/readme.html#downloading-and-building-the-application"
  },"10": {
    "doc": "SDSPI driver asynchronous - SDSPI Read Write",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_l10_xpro.X | SAML10 Xplained Pro Evaluation Kit | . |   |   | . Setting up SAML10 Xplained Pro Evaluation Kit . | To run the demo, the following additional hardware are required: . | IO1 Xplained PRO Extension Kit | One micro-sd card | . | Connect the IO1 Xplained PRO Extension Kit to the EXT1 header | Insert the micro-SD Card in the IO1 Xplained PRO Extension Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/driver/sdspi/async/sdspi_read_write/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/sdspi/async/sdspi_read_write/readme.html#setting-up-the-hardware"
  },"11": {
    "doc": "SDSPI driver asynchronous - SDSPI Read Write",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | The LED is turned ON when the read data from the SD card matches with the written data | . Refer to the following table for LED name: . | Board | LED Name | . | SAML10 Xplained Pro Evaluation Kit | LED0 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/driver/sdspi/async/sdspi_read_write/readme.html#running-the-application",
    "relUrl": "/apps/driver/sdspi/async/sdspi_read_write/readme.html#running-the-application"
  },"12": {
    "doc": "SDSPI driver asynchronous - SDSPI Read Write",
    "title": "SDSPI driver asynchronous - SDSPI Read Write",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/driver/sdspi/async/sdspi_read_write/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/driver/spi/async/spi_multi_slave/readme.html#spi-driver-asynchronous---multi-slave",
    ...
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/driver/spi/async/spi_multi_slave/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/driver/spi/async/spi_multi_slave/readme.html#downloading-and-building-the-application",
    ...
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/driver/spi/async/spi_multi_slave/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/spi/async/spi_multi_slave/readme.html#setting-up-the-hardware"
  },"17": {
    "doc": "SPI Driver asynchronous - multi slave",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | LED indicates success or failure: . | The LED is turned ON when the value read from the EEPROM matched with the written value | . | . Refer to the following table for LED name: . | Board | LED Name | . | SAML10 Xplained Pro Evaluation Kit | LED0 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/driver/spi/async/spi_multi_slave/readme.html#running-the-application",
    "relUrl": "/apps/driver/spi/async/spi_multi_slave/readme.html#running-the-application"
  },"18": {
    "doc": "SPI Driver asynchronous - multi slave",
    "title": "SPI Driver asynchronous - multi slave",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/driver/spi/async/spi_multi_slave/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/driver/usart/async/usart_echo/readme.html#usart-driver-asynchronous---uart-echo",
    ...
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/fs/nvm_fat/readme.html#fat-filesystem-using-nvm-media",
    ...
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/fs/nvm_fat/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/fs/nvm_fat/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/fs/nvm_fat/readme.html#downloading-and-building-the-application"
  },"28": {
    "doc": "FAT filesystem using NVM Media",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_l10_xpro.X | SAML10 Xplained Pro Evaluation Kit | . |   |   | . Setting up SAML10 Xplained Pro Evaluation Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/fs/nvm_fat/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/fs/nvm_fat/readme.html#setting-up-the-hardware"
  },"29": {
    "doc": "FAT filesystem using NVM Media",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | Press Switch to start the file operations | The LED is turned ON when the File FILE.TXT has the app data “Hello World” written in it | . Refer to the following table for switch and LED name: . | Board | Switch name | LED Name | . | SAML10 Xplained Pro Evaluation Kit | SW0 | LED0 | . |   |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/fs/nvm_fat/readme.html#running-the-application",
    "relUrl": "/apps/fs/nvm_fat/readme.html#running-the-application"
  },"30": {
    "doc": "FAT filesystem using NVM Media",
    "title": "FAT filesystem using NVM Media",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/fs/nvm_fat/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/rtos/freertos/basic_freertos/readme.html#freertos-basic",
    ...
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/rtos/freertos/basic_freertos/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/rtos/freertos/basic_freertos/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/rtos/freertos/basic_freertos/readme.html#downloading-and-building-the-application"
  },"34": {
    "doc": "FreeRTOS basic",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_l10_xpro.X | SAML10 Xplained Pro Evaluation Kit | . |   |   | . Setting up SAML10 Xplained Pro Evaluation Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/rtos/freertos/basic_freertos/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/rtos/freertos/basic_freertos/readme.html#setting-up-the-hardware"
  },"35": {
    "doc": "FreeRTOS basic",
    "title": "Running the Application",
    "content": " ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/rtos/freertos/basic_freertos/readme.html#running-the-application",
    "relUrl": "/apps/rtos/freertos/basic_freertos/readme.html#running-the-application"
  },"36": {
    "doc": "FreeRTOS basic",
    "title": "Running the Application",
    "content": ". | Open the Terminal application (Ex.:Tera Term) on the computer. | Connect to the EDBG Virtual COM port and configure the serial settings as follows: . Baud : 115200 . Data : 8 Bits . Parity : None . Stop : 1 Bit . Flow Control : None . | Build and program the application using its IDE. | Observe the following output on the terminal. | Enter any character on the terminal to run task3. Notice how task1 and task2 are pre-empted by task3 as task3 is of higher priority than task1 and task2. Pressing character ‘l’ or “L’ toggles the on board LED. Notice how task1 and task2 are not run when characters are entered continuously on the terminal. | Press the user switch on the board to run task4. Notice how task4 preempts all other tasks as it is of highest priority. | . Refer to the following table for LED and Switch name: . | Board | LED Name | Switch Name | . | SAML10 Xplained Pro Evaluation Kit | LED0 | SW0 | . |   |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/rtos/freertos/basic_freertos/readme.html#running-the-application-1",
    "relUrl": "/apps/rtos/freertos/basic_freertos/readme.html#running-the-application-1"
  },"37": {
    "doc": "FreeRTOS basic",
    "title": "FreeRTOS basic",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/rtos/freertos/basic_freertos/readme.html",
    "relUrl": "/apps/rtos/freertos/basic_freertos/readme.html"
  },"38": {
    "doc": "Title",
    "title": "Title",
    "content": "short_description . ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/rtos/freertos/basic_freertos_trustZone/NonSecure/readme.html#title",
    "relUrl": "/apps/rtos/freertos/basic_freertos_trustZone/NonSecure/readme.html#title"
  },"39": {
    "doc": "Title",
    "title": "Description",
    "content": "long_description . ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/rtos/freertos/basic_freertos_trustZone/NonSecure/readme.html#description",
    "relUrl": "/apps/rtos/freertos/basic_freertos_trustZone/NonSecure/readme.html#description"
  },"40": {
    "doc": "Title",
    "title": "Downloading and building the application",
    "content": "To clone or download this application from Github, go to the main page of this repository and then click Clone button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these instructions. Path of the application within the repository is apps/rtos/freertos/basic_freertos_trustZone/NonSecure/firmware . To build the application, refer to the following table and open the project using its IDE. | Project Name | Description | . | sam_l11_xpro_NonSecure.X | MPLABX project for SAML11 Xplained Pro Evaluation Kit | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/rtos/freertos/basic_freertos_trustZone/NonSecure/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/rtos/freertos/basic_freertos_trustZone/NonSecure/readme.html#downloading-and-building-the-application"
  },"41": {
    "doc": "Title",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_l11_xpro_NonSecure.X | SAML11 Xplained Pro Evaluation Kit | . |   |   | . Setting up SAML11 Xplained Pro Evaluation Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/rtos/freertos/basic_freertos_trustZone/NonSecure/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/rtos/freertos/basic_freertos_trustZone/NonSecure/readme.html#setting-up-the-hardware"
  },"42": {
    "doc": "Title",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | . Refer to the following table for LED name: . | Board | LED Name | . | SAML11 Xplained Pro Evaluation Kit | LED0 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/rtos/freertos/basic_freertos_trustZone/NonSecure/readme.html#running-the-application",
    "relUrl": "/apps/rtos/freertos/basic_freertos_trustZone/NonSecure/readme.html#running-the-application"
  },"43": {
    "doc": "Title",
    "title": "Title",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/rtos/freertos/basic_freertos_trustZone/NonSecure/readme.html",
    "relUrl": "/apps/rtos/freertos/basic_freertos_trustZone/NonSecure/readme.html"
  },"44": {
    "doc": "Title",
    "title": "Title",
    "content": "short_description . ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/rtos/freertos/basic_freertos_trustZone/Secure/readme.html#title",
    "relUrl": "/apps/rtos/freertos/basic_freertos_trustZone/Secure/readme.html#title"
  },"45": {
    "doc": "Title",
    "title": "Description",
    "content": "long_description . ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/rtos/freertos/basic_freertos_trustZone/Secure/readme.html#description",
    "relUrl": "/apps/rtos/freertos/basic_freertos_trustZone/Secure/readme.html#description"
  },"46": {
    "doc": "Title",
    "title": "Downloading and building the application",
    "content": "To clone or download this application from Github, go to the main page of this repository and then click Clone button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these instructions. Path of the application within the repository is apps/rtos/freertos/basic_freertos_trustZone/Secure/firmware . To build the application, refer to the following table and open the project using its IDE. | Project Name | Description | . | sam_l11_xpro_Secure.X | MPLABX project for SAML11 Xplained Pro Evaluation Kit | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/rtos/freertos/basic_freertos_trustZone/Secure/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/rtos/freertos/basic_freertos_trustZone/Secure/readme.html#downloading-and-building-the-application"
  },"47": {
    "doc": "Title",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_l11_xpro_Secure.X | SAML11 Xplained Pro Evaluation Kit | . |   |   | . Setting up SAML11 Xplained Pro Evaluation Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/rtos/freertos/basic_freertos_trustZone/Secure/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/rtos/freertos/basic_freertos_trustZone/Secure/readme.html#setting-up-the-hardware"
  },"48": {
    "doc": "Title",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | . Refer to the following table for LED name: . | Board | LED Name | . | SAML11 Xplained Pro Evaluation Kit | LED0 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/rtos/freertos/basic_freertos_trustZone/Secure/readme.html#running-the-application",
    "relUrl": "/apps/rtos/freertos/basic_freertos_trustZone/Secure/readme.html#running-the-application"
  },"49": {
    "doc": "Title",
    "title": "Title",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/rtos/freertos/basic_freertos_trustZone/Secure/readme.html",
    "relUrl": "/apps/rtos/freertos/basic_freertos_trustZone/Secure/readme.html"
  },"50": {
    "doc": "TrustZone FreeRTOS basic",
    "title": "TrustZone FreeRTOS basic",
    "content": "This example application blinks an LED to show the FreeRTOS threads that are running in non-secure mode and to indicate status. ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/rtos/freertos/basic_freertos_trustZone/readme.html#trustzone-freertos-basic",
    "relUrl": "/apps/rtos/freertos/basic_freertos_trustZone/readme.html#trustzone-freertos-basic"
  },"51": {
    "doc": "TrustZone FreeRTOS basic",
    "title": "Description",
    "content": "This demonstrates TrustZone feature and uses two projects viz., Secure and Non-Secure Project that work together on the same MCU and offering security isolation between the Trusted and the Non-trusted resources in the device. FreeRTOS and BSP are configured and run in Non-Secure mode. This demonstration creates three tasks and a queue. Task1 sends message to Task2 and Task3 to unblock and toggle an LED. Task1 priority is low compared to Task2 and Task3 which shares same priority. | Task1: This task sends the data (i.e. delay, the amount of time for which the task need blocked) to Task2 and Task3 using a queue, then Task1 blocks itself for 200ms to allow other tasks to schedule and run | Task2: This task blocks until it receives the data from queue, if the Task2 receives the expected delay (i.e. 1000ms) from Task1 then toggles the LED and blocks itself for the amount of delay received | Task3: This task blocks until it receives the data from queue, if the Task3 receives the expected delay (i.e. 100ms) from Task1 then toggles the LED and blocks itself for the amount of delay received | . ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/rtos/freertos/basic_freertos_trustZone/readme.html#description",
    "relUrl": "/apps/rtos/freertos/basic_freertos_trustZone/readme.html#description"
  },"52": {
    "doc": "TrustZone FreeRTOS basic",
    "title": "Downloading and building the application",
    "content": "To clone or download this application from Github, go to the main page of this repository and then click Clone button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these instructions. Path of the application within the repository is as shown below: . | Type | Path |   | . | Project group | apps/rtos/freertos/basic_freertos_trustZone |   | . | Secure Project | apps/rtos/freertos/basic_freertos_trustZone/Secure/firmware |   | . | Non-Secure Project | apps/rtos/freertos/basic_freertos_trustZone/NonSecure/firmware |   | . |   |   |   | . To build the application, refer to the following table and open the project using its IDE. | Project Name | Description | . | sam_l11_xpro_Secure.X sam_l11_xpro_NonSecure.X | Secure and Non-secure MPLABX project for SAML11 Xplained Pro Evaluation Kit | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/rtos/freertos/basic_freertos_trustZone/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/rtos/freertos/basic_freertos_trustZone/readme.html#downloading-and-building-the-application"
  },"53": {
    "doc": "TrustZone FreeRTOS basic",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_l11_xpro_Secure.X sam_l11_xpro_NonSecure.X | SAML11 Xplained Pro Evaluation Kit | . |   |   | . Setting up SAML11 Xplained Pro Evaluation Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/rtos/freertos/basic_freertos_trustZone/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/rtos/freertos/basic_freertos_trustZone/readme.html#setting-up-the-hardware"
  },"54": {
    "doc": "TrustZone FreeRTOS basic",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | The LED indicates the success or failure. | The LED toggles on success i.e. each time when the Task2 or Task3 receives a valid message | . | . Refer to the following table for LED name: . | Board | LED Name | . | SAML11 Xplained Pro Evaluation Kit | LED0 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/rtos/freertos/basic_freertos_trustZone/readme.html#running-the-application",
    "relUrl": "/apps/rtos/freertos/basic_freertos_trustZone/readme.html#running-the-application"
  },"55": {
    "doc": "TrustZone FreeRTOS basic",
    "title": "TrustZone FreeRTOS basic",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/rtos/freertos/basic_freertos_trustZone/readme.html",
    "relUrl": "/apps/rtos/freertos/basic_freertos_trustZone/readme.html"
  },"56": {
    ...
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/system/console_debug/sys_console_debug_uart_read_write/readme.html#console-debug-system-service-using-uart",
    ...
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/system/console_debug/sys_console_debug_uart_read_write/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/system/console_debug/sys_console_debug_uart_read_write/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/system/console_debug/sys_console_debug_uart_read_write/readme.html#downloading-and-building-the-application"
  },"59": {
    "doc": "Console Debug System Service using UART",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_l10_xpro.X | SAML10 Xplained Pro Evaluation Kit | . |   |   | . Setting up SAML10 Xplained Pro Evaluation Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/system/console_debug/sys_console_debug_uart_read_write/readme.html#setting-up-the-hardware",
    ...
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/system/console_debug/sys_console_debug_uart_read_write/readme.html#running-the-application",
    "relUrl": "/apps/system/console_debug/sys_console_debug_uart_read_write/readme.html#running-the-application"
  },"61": {
    "doc": "Console Debug System Service using UART",
    "title": "Console Debug System Service using UART",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/system/console_debug/sys_console_debug_uart_read_write/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/system/time/sys_time_multiclient/readme.html#time-system-service-multi-client",
    ...
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/system/time/sys_time_multiclient/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/system/time/sys_time_multiclient/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/system/time/sys_time_multiclient/readme.html#downloading-and-building-the-application"
  },"65": {
    "doc": "Time System Service multi-client",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_l10_xpro.X | SAML10 Xplained Pro Evaluation Kit | . |   |   | . Setting up SAML10 Xplained Pro Evaluation Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/system/time/sys_time_multiclient/readme.html#setting-up-the-hardware",
    ...
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/system/time/sys_time_multiclient/readme.html#running-the-application",
    "relUrl": "/apps/system/time/sys_time_multiclient/readme.html#running-the-application"
  },"67": {
    "doc": "Time System Service multi-client",
    "title": "Time System Service multi-client",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/system/time/sys_time_multiclient/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/driver/i2c/async/i2c_eeprom/readme.html#i2c-driver-asynchronous---i2c-eeprom",
    ...
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/driver/i2c/async/i2c_eeprom/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/driver/i2c/async/i2c_eeprom/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/i2c/async/i2c_eeprom/readme.html#downloading-and-building-the-application"
  },"71": {
    "doc": "I2C driver asynchronous - I2C EEPROM",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_l10_xpro.X | SAML10 Xplained Pro Evaluation Kit | . |   |   | . Setting up SAML10 Xplained Pro Evaluation Kit . | To run the demo, one EEPROM 3 Click board is required . | Connect EEPROM 3 click Board on to the mikroBUS header | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/driver/i2c/async/i2c_eeprom/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/i2c/async/i2c_eeprom/readme.html#setting-up-the-hardware"
  },"72": {
    "doc": "I2C driver asynchronous - I2C EEPROM",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | LED indicates success or failure: . | The LED is turned ON when the value read from the EEPROM matched with the written value | . | . Refer to the following table for LED name: . | Board | LED Name | . | SAML10 Xplained Pro Evaluation Kit | LED0 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/driver/i2c/async/i2c_eeprom/readme.html#running-the-application",
    "relUrl": "/apps/driver/i2c/async/i2c_eeprom/readme.html#running-the-application"
  },"73": {
    "doc": "I2C driver asynchronous - I2C EEPROM",
    "title": "I2C driver asynchronous - I2C EEPROM",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/apps/driver/i2c/async/i2c_eeprom/readme.html",
    "relUrl": "/apps/driver/i2c/async/i2c_eeprom/readme.html"
  },"74": {
    "doc": "Release notes",
    "title": "Microchip MPLAB® Harmony 3 Release Notes",
    "content": " ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/release_notes.html#microchip-mplab-harmony-3-release-notes",
    "relUrl": "/release_notes.html#microchip-mplab-harmony-3-release-notes"
  },"75": {
    "doc": "Release notes",
    "title": "Harmony 3 peripheral library application examples for SAM L10/L11 family  v3.1.0",
    "content": "Development kit and demo application support . Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLABx applications | KEIL applications | . | SAML10 Xplained Pro Evaluation Kit | 9 | 1 | . | SAML11 Xplained Pro Evaluation Kit | 2 | 0 | . New Features . | None | . Known Issues . | None | . Development Tools . | MPLAB® X IDE v5.45 | MPLAB® X IDE plug-ins: . | MPLAB® Harmony Configurator (MHC) v3.7.0 | . | MPLAB® XC32 C/C++ Compiler v2.50 | KEIL MDK v5.30 or above | . ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/release_notes.html#harmony-3-peripheral-library-application-examples-for-sam-l10l11-family--v310",
    "relUrl": "/release_notes.html#harmony-3-peripheral-library-application-examples-for-sam-l10l11-family--v310"
  },"76": {
    "doc": "Release notes",
    "title": "Harmony 3 driver and system service application examples for SAM L10/L11 family  v3.0.1",
    ...
    "url": "http://localhost:4000/core_apps_sam_l10_l11/release_notes.html#harmony-3-driver-and-system-service-application-examples-for-sam-l10l11-family--v301",
    "relUrl": "/release_notes.html#harmony-3-driver-and-system-service-application-examples-for-sam-l10l11-family--v301"
  },"77": {
    "doc": "Release notes",
    "title": "Harmony 3 driver and system service application examples for SAM L10/L11 family  v3.0.0",
    "content": "Development kit and demo application support . Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLABx applications | KEIL applications | . | SAML11 Xplained Pro Evaluation Kit | 2 | 0 | . | SAML10 Xplained Pro Evaluation Kit | 9 | 1 | . New Features . New features added in this release are as follows: . | Applications migrated from csp repository to this new application repository for SAM L10/L11 development boards | . Known Issues . The current known issues are as follows: . | The following product family requires newer DFP version to be downloaded from packs server and to be used in the MPLAB project to build with MPLAB X IDE v5.4. | SAM L10/L11 Family: SAML10_DFP v3.3.82, SAML11_DFP v4.0.114 | . | . Development Tools . | MPLAB® X IDE v5.40 | MPLAB® X IDE plug-ins: . | MPLAB® Harmony Configurator (MHC) v3.6.0 | . | MPLAB® XC32 C/C++ Compiler v2.41 | KEIL MDK v5.30 or above | . ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/release_notes.html#harmony-3-driver-and-system-service-application-examples-for-sam-l10l11-family--v300",
    "relUrl": "/release_notes.html#harmony-3-driver-and-system-service-application-examples-for-sam-l10l11-family--v300"
  },"78": {
    "doc": "Release notes",
    "title": "Release notes",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/release_notes.html",
    "relUrl": "/release_notes.html"
  },"79": {
    "doc": "Harmony 3 driver and system service application examples for SAM L10/L11 family",
    "title": "Harmony 3 driver and system service application examples for SAM L10/L11 family",
    "content": "[![MCHP](https://www.microchip.com/ResourcePackages/Microchip/assets/dist/images/logo.png)](https://www.microchip.com) # Harmony 3 driver and system service application examples for SAM L10/L11 family MPLAB® Harmony 3 is an extension of the MPLAB® ecosystem for creating embedded firmware solutions for Microchip 32-bit SAM and PIC® microcontroller and microprocessor devices. Refer to the following links for more information. - [Microchip 32-bit MCUs](https://www.microchip.com/design-centers/32-bit) - [Microchip 32-bit MPUs](https://www.microchip.com/design-centers/32-bit-mpus) - [Microchip MPLAB X IDE](https://www.microchip.com/mplab/mplab-x-ide) - [Microchip MPLAB® Harmony](https://www.microchip.com/mplab/mplab-harmony) - [Microchip MPLAB® Harmony Pages](https://microchip-mplab-harmony.github.io/) This repository contains the MPLAB® Harmony 3 driver and system service application examples for SAM L10/L11 family - [Release Notes](/core_apps_sam_l10_l11/release_notes.html) - [MPLAB® Harmony License](/core_apps_sam_l10_l11/mplab_harmony_license.html) To clone or download these applications from Github, go to the [main page of this repository](https://github.com/Microchip-MPLAB-Harmony/core_apps_sam_l10_l11) and then click **Clone** button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these [instructions](https://github.com/Microchip-MPLAB-Harmony/contentmanager/wiki). ## Contents Summary | Folder | Description | --- | --- | apps | Contains driver and system service example applications | docs | Contains documentation in html format for offline viewing (to be used only after cloning this repository onto a local machine). Use [github pages](https://microchip-mplab-harmony.github.io/core_apps_sam_l10_l11/) of this repository for viewing it online. | ## Code Examples The following applications are provided to demonstrate the typical or interesting usage models of one or more peripheral libraries. | Name | Description | ---- | ----------- | [I2C driver asynchronous - I2C EEPROM](/core_apps_sam_l10_l11/apps/driver/i2c/async/i2c_eeprom/readme.html) | This example application shows how to use the I2C driver in asynchronous mode to perform operations on the EEPROM | [I2C driver asynchronous - I2C Multi-client](/core_apps_sam_l10_l11/apps/driver/i2c/async/i2c_multi_slave/readme.html) | This example application shows how to use multi-client feature of the I2C driver in asynchronous mode to communicate with temperature sensor and an EEPROM | [SDSPI driver asynchronous - SDSPI Read Write](/core_apps_sam_l10_l11/apps/driver/sdspi/async/sdspi_read_write/readme.html) | This example application shows how to use the SDSPI driver in asynchronous mode to perform non-blocking operations on the SD Card Media | [SPI Driver asynchronous - multi slave ](/core_apps_sam_l10_l11/apps/driver/spi/async/spi_multi_slave/readme.html) | This example demonstrates how to use single instance of the SPI driver in asynchronous mode to communicate with multiple EEPROMs | [USART driver asynchronous - UART echo](/core_apps_sam_l10_l11/apps/driver/usart/async/usart_echo/readme.html) | This example echoes the received characters over the console using the USART driver in asynchronous mode | [FAT filesystem using NVM Media](/core_apps_sam_l10_l11/apps/fs/nvm_fat/readme.html) | This application shows an example of implementing a FAT disk in the device internal Flash memory | [FreeRTOS basic](/core_apps_sam_l10_l11/apps/rtos/freertos/basic_freertos/readme.html) | This example application demonstrates context switching between four tasks of different priorites. Two tasks run periodically while the other two tasks are event driven | [TrustZone FreeRTOS basic](/core_apps_sam_l10_l11/apps/rtos/freertos/basic_freertos_trustZone/readme.html) | This example application blinks an LED to show the FreeRTOS threads that are running in non-secure mode and to indicate status | [Title](/core_apps_sam_l10_l11/apps/rtos/freertos/basic_freertos_trustZone/NonSecure/readme.html) | short_description | [Title](/core_apps_sam_l10_l11/apps/rtos/freertos/basic_freertos_trustZone/Secure/readme.html) | short_description | [Console Debug System Service using UART](/core_apps_sam_l10_l11/apps/system/console_debug/sys_console_debug_uart_read_write/readme.html) | This example application demonstrates the UART based console and debug system service | [Time System Service multi-client](/core_apps_sam_l10_l11/apps/system/time/sys_time_multiclient/readme.html) | This example application demonstrates the multi-client system timer functionality | ____ [![License](https://img.shields.io/badge/license-Harmony%20license-orange.svg)](https://github.com/Microchip-MPLAB-Harmony/core_apps_sam_l10_l11/blob/master/mplab_harmony_license.md) [![Latest release](https://img.shields.io/github/release/Microchip-MPLAB-Harmony/core_apps_sam_l10_l11.svg)](https://github.com/Microchip-MPLAB-Harmony/core_apps_sam_l10_l11/releases/latest) [![Latest release date](https://img.shields.io/github/release-date/Microchip-MPLAB-Harmony/core_apps_sam_l10_l11.svg)](https://github.com/Microchip-MPLAB-Harmony/core_apps_sam_l10_l11/releases/latest) [![Commit activity](https://img.shields.io/github/commit-activity/y/Microchip-MPLAB-Harmony/core_apps_sam_l10_l11.svg)](https://github.com/Microchip-MPLAB-Harmony/core_apps_sam_l10_l11/graphs/commit-activity) [![Contributors](https://img.shields.io/github/contributors-anon/Microchip-MPLAB-Harmony/core_apps_sam_l10_l11.svg)]() ____ [![Follow us on Youtube](https://img.shields.io/badge/Youtube-Follow%20us%20on%20Youtube-red.svg)](https://www.youtube.com/user/MicrochipTechnology) [![Follow us on LinkedIn](https://img.shields.io/badge/LinkedIn-Follow%20us%20on%20LinkedIn-blue.svg)](https://www.linkedin.com/company/microchip-technology) [![Follow us on Facebook](https://img.shields.io/badge/Facebook-Follow%20us%20on%20Facebook-blue.svg)](https://www.facebook.com/microchiptechnology/) [![Follow us on Twitter](https://img.shields.io/twitter/follow/MicrochipTech.svg?style=social)](https://twitter.com/MicrochipTech) [![](https://img.shields.io/github/stars/Microchip-MPLAB-Harmony/core_apps_sam_l10_l11.svg?style=social)]() [![](https://img.shields.io/github/watchers/Microchip-MPLAB-Harmony/core_apps_sam_l10_l11.svg?style=social)]() ",
    "url": "http://localhost:4000/core_apps_sam_l10_l11/",
    "relUrl": "/"
  }
}
`;
...
var repo_name = "core_apps_sam_l10_l11";
var doc_folder_name = "docs";
var localhost_path = "http://localhost:4000/";
var home_index_string = "Harmony 3 driver and system service application examples for SAM L10/L11 family";
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', 'http://localhost:4000/core_apps_sam_l10_l11/assets/css/just-the-docs-' + theme + '.css');
}
